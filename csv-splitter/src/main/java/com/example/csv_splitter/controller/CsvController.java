...
public class CsvController {
    ...
    public ResponseEntity<?> generateCsvFiles(
        ...
        try {
            ...
            boolean sameFileMode = rowsPerFile != null && rowsPerFile > 1;

            if (sameFileMode) {
                log.info("Generating {} CSV files with {} rows each (Same file mode)", count, rowsPerFile);
            } else {
