## Just Clone the repository and  open the editor and run the application after application started running go to the browser and search localhost http://localhost:8080/
